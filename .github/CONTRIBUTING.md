...
-  If you find a bug, please search for it in the [Issues](https://github.com/nebrass/simple-kubernetes-webhook/issues), and if it isn't already tracked,
   [create a new issue](https://github.com/nebrass/simple-kubernetes-webhook/issues/new). Fill out the "Bug Report" section of the issue template. Even if an Issue is closed, feel free to comment and add details, it will still
   be reviewed.
...
### New Features :bulb:
-  If you'd like to add new functionality to this project, describe the problem you want to solve in a [new Issue](https://github.com/nebrass/simple-kubernetes-webhook/issues/new).
...
-  If you'd like to improve the tests, you want to make the documentation clearer, you have an
  ...
  -  If not, [open an Issue](https://github.com/nebrass/simple-kubernetes-webhook/issues/new) to discuss the idea first.
